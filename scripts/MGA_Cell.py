...
args['task_name'] = 'cell'  # change
args['data_name'] = 'Cell'  # change
args['times'] = 10


# selected task, generate select task index, task class, and classification_num
args['select_task_list'] = ['BJeLR', 'HPDE-C7', 'IEC_6', 'HEPG2', 'LL47', 'Jurkat', 
                            'SK-BR-3', 'HUVEC', 'H69AR', 'Ba_Slash_F3', 'A549', 'HMLE_sh_Ecad', 
                            'HEK293', 'KKLEB', 'HT1080', 'H1299']  # change
args['select_task_index'] = []
args['classification_num'] = 0
args['regression_num'] = 0
args['all_task_list'] = ['BJeLR', 'HPDE-C7', 'IEC_6', 'HEPG2', 'LL47', 'Jurkat', 
                         'SK-BR-3', 'HUVEC', 'H69AR', 'Ba_Slash_F3', 'A549', 'HMLE_sh_Ecad', 
                         'HEK293', 'KKLEB', 'HT1080', 'H1299']  # change
...
for task in args['select_task_list']:
    if task in ['BJeLR', 'HPDE-C7', 'IEC_6', 'HEPG2', 'LL47', 'Jurkat', 
                'SK-BR-3', 'HUVEC', 'H69AR', 'Ba_Slash_F3', 'A549', 'HMLE_sh_Ecad', 
                'HEK293', 'KKLEB', 'HT1080', 'H1299']:
