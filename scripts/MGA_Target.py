...
args['task_name'] = 'Target'  # change
args['data_name'] = 'Target'  # change
args['times'] = 10


# selected task, generate select task index, task class, and classification_num
args['select_task_list'] = ['ADRB3','ADRB2','CHRM1','AR','ADRA1A','MAOA','CHRM2','HTR1A',
                            'DRD2','HTR2A', 'CHRM3','ADORA3','CCKAR','HRH2','EDNRB','ADRA2A','EDNRA',
                            'HTR2B','OPRD','OPRM','ADORA1','HTR3A','GABRA1','BDKRB2',
                            'NPY1R','OPRK','DRD1','HTR2C','PDE3','ADRB1','AGTR1','ADRA2B','HRH1','ADORA2A']  # change
args['select_task_index'] = []
args['classification_num'] = 0
args['regression_num'] = 0
args['all_task_list'] = ['ADRB3','ADRB2','CHRM1','AR','ADRA1A','MAOA','CHRM2','HTR1A',
                         'DRD2','HTR2A', 'CHRM3','ADORA3','CCKAR','HRH2','EDNRB','ADRA2A','EDNRA',
                         'HTR2B','OPRD','OPRM','ADORA1','HTR3A','GABRA1','BDKRB2',
                         'NPY1R','OPRK','DRD1','HTR2C','PDE3','ADRB1','AGTR1','ADRA2B','HRH1','ADORA2A']  # change
...
for task in args['select_task_list']:
    if task in ['ADRB3','ADRB2','CHRM1','AR','ADRA1A','MAOA','CHRM2','HTR1A',
                'DRD2','HTR2A', 'CHRM3','ADORA3','CCKAR','HRH2','EDNRB','ADRA2A','EDNRA',
                'HTR2B','OPRD','OPRM','ADORA1','HTR3A','GABRA1','BDKRB2',
                'NPY1R','OPRK','DRD1','HTR2C','PDE3','ADRB1','AGTR1','ADRA2B','HRH1','ADORA2A']:
