...
args['task_name'] = 'Pathway'  # change
args['data_name'] = 'Pathway'  # change
args['times'] = 10

df = pd.read_csv('data/tox_data_v1/Pathway/Pathway.csv')
print(df.columns)

# selected task, generate select task index, task class, and classification_num
args['select_task_list'] = ['NR-AR-LBD', 'SR-p53', 'NR-ER-LBD', 'NR-Aromatase', 'SR-ARE',
                            'NR-AR', 'SR-HSE', 'SR-MMP', 'SR-ATAD5', 'NR-ER', 'NR-PPAR-gamma',
                            'NR-AhR',]  # change
args['select_task_index'] = []
args['classification_num'] = 0
args['regression_num'] = 0
args['all_task_list'] = ['NR-AR-LBD', 'SR-p53', 'NR-ER-LBD', 'NR-Aromatase', 'SR-ARE',
                         'NR-AR', 'SR-HSE', 'SR-MMP', 'SR-ATAD5', 'NR-ER', 'NR-PPAR-gamma',
                         'NR-AhR',]  # change
...
for task in args['select_task_list']:
    if task in ['NR-AR-LBD', 'SR-p53', 'NR-ER-LBD', 'NR-Aromatase', 'SR-ARE',
                'NR-AR', 'SR-HSE', 'SR-MMP', 'SR-ATAD5', 'NR-ER', 'NR-PPAR-gamma',
                'NR-AhR',]:
